...
const IngredientFilter: React.FC = () => {
  ...
  // Get all unique ingredients from the food data
  const allIngredients = Array.from(
    new Set(foodData.flatMap((recipe: Recipe) => recipe.ingredients))
  );

  // Filter the recipes based on the selected ingredients
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        ...
        {/* Card-like container for checkboxes */}
        ...
        {filteredRecipes.length > 0 ? (
          <ul>
            {filteredRecipes.map((recipe) => (
              <li key={recipe.id} className="mb-4 p-4 bg-gray-100 rounded-lg shadow-md">
